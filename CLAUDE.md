...
│
├── docs/                           📝 To create
│   ├── how-to-play.md             # Game rules for humans
...
### Setup
- Deck: 28 cards total
  - 4 cards each of values 1, 2, 3, 4, 5, 6
  - 4 wild cards (value 0, player chooses 1-7)
- Players start with no cards
- Goal: Get total closest to 7 without going over

### Gameplay
1. Players take turns in order
2. On your turn, choose: **Draw** or **Stand**
3. If you draw:
   - Take the top card from deck
   - Add to your total
   - If wild, choose a value 1-7
   - If total > 7, you **bust** (score = 0)
4. If you stand:
   - Lock in your current total
   - No more turns this game
5. Game ends when all players have stood or busted

### Scoring
- Busted players score 0
- Non-busted players score their total
- Highest score wins
- Ties are draws
